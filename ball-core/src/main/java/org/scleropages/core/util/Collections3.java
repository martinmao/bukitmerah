...
public class Collections3 {
	...
	public static Map extractToMap(final Iterable<?> collection, final String keyPropertyName,
	...
	public static <K, V> List<V> getAllValues(Map<K, V> map, @SuppressWarnings("unchecked") K... keys) {
