...
//import org.scleropages.crud.uid.provider.leaf.common.PropertyFactory;
...
//import org.scleropages.crud.uid.provider.leaf.common.ZeroIDGen;
...
//        }
    ...
    public void afterPropertiesSet() throws Exception {
        Assert.notNull(idGen, "idGen not provided.");
        if (idGen.init()) {
            logger.info("Segment Service Init Successfully");
        } else {
