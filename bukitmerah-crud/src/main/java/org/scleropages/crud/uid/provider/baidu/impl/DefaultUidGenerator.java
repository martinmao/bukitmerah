 ...
 */
package org.scleropages.crud.uid.provider.baidu.impl;

import org.apache.commons.lang3.StringUtils;
import org.scleropages.crud.uid.provider.baidu.BitsAllocator;
import org.scleropages.crud.uid.provider.baidu.UidGenerator;
import org.scleropages.crud.uid.provider.baidu.exception.UidGenerateException;
import org.scleropages.crud.uid.provider.baidu.utils.DateUtils;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    /**
     * Customer epoch, unit as second. For example 2021-07-01 (ms: 1625068800000)
     */
    protected String epochStr = "2021-07-01";

    protected long epochSeconds = TimeUnit.MILLISECONDS.toSeconds(1625068800000L);
